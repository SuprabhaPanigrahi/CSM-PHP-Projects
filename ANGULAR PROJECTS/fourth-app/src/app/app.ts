...
export class App {
  title: string = 'DATABINDING TUTORIAL IN ANGULAR ';
  price:number=450;
  status: boolean = true;
  numbers :number[]=[10,20,30,40,50];
  names:string[]=['Angular','React','Vue','Svelte','Ember' ];
  student1:Student={
    id:101,
    name:'John Doe',
    course:'Angular',
